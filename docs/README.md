...
- **[reference/](reference/)** - Technical reference documentation
  - [EPISODE_STATUS_ANALYSIS.md](reference/EPISODE_STATUS_ANALYSIS.md) - Episode status system analysis
  - [EPISODE_STATUS_QUICK_REF.md](reference/EPISODE_STATUS_QUICK_REF.md) - Episode status quick reference

## Quick Links

- Getting started: See [../README.md](../README.md) for quick start instructions
- Architecture overview: See [architecture/technical.md](architecture/technical.md)
- Design system: See [architecture/design.md](architecture/design.md)
